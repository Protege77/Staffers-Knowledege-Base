...
.submit-intro { color: var(--gray); margin-bottom: 2rem; line-height: 1.6; }
.field { display: flex; flex-direction: column; gap: 6px; margin-bottom: 1.25rem; }
.field label { font-size: 0.875rem; font-weight: 600; color: var(--darkgray); }
.required { color: var(--secondary); margin-left: 2px; }
.optional { font-weight: 400; color: var(--gray); font-size: 0.8rem; }
.field input, .field textarea {
  padding: 10px 14px; border: 1.5px solid var(--lightgray); border-radius: 8px;
  background: var(--light); color: var(--darkgray); font-size: 0.95rem; font-family: inherit;
...
button[type=submit] {
  width: 100%; padding: 12px; background: var(--secondary); color: #fff; border: none;
...
.message { margin-top: 1.25rem; padding: 12px 16px; border-radius: 8px; font-size: 0.9rem; font-weight: 500; }
.success { background: #dcfce7; color: #15803d; }
.error { background: #fee2e2; color: #b91c1c; }
</style>

<div class="submit-wrapper">
  <p class="submit-intro">Found something worth sharing? Paste the link below and Claude will classify and summarise it automatically. It'll appear in the knowledge base within a minute.</p>
  <form id="submitForm">
    <div class="field">
